...
if(isset($_GET['class_id']) && isset($_GET['id']) && isset($_GET['user_id']) && isset($_POST['submit']))
{
	...
	if($ans == 'IsmARCusJuNIUSbruTustHEYOuNGErMyFrIEND')
	{
	}
...
<p>Can you decrypt what the great emperor is trying to tell us?<br></p>
<p>HXdQJeNPXccQNOUJP! RbvJALdbSdWRDBkadCdbcQNHXdWPNaVhOaRNWM</p><br>
