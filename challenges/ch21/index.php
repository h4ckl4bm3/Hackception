...
if(isset($_GET['class_id']) && isset($_GET['id']) && isset($_GET['user_id']) && isset($_POST['submit']))
{
	...
	if($ans == '413eca58d76f2a7eec1f0ca1071aff33')
	{
		...
		{		
			...
			echo "Wooow. Congrats.. Go ahead.!";
		}
		else
		{	echo "u have already solved.Try some other challenges. :)";	}
	}
...
<a href='stringme.jpg' target='_blank'>Click here for link</a>
<br><br>
